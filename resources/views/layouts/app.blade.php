            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            <li><a href="{{ route('message.index') }}">Notificaciones <span class="badge">2</span></a></li>
                            <li class="dropdown">
            ...
            <div class="container-fluid">
                ...
                <div id="sidebar-wrapper">
                    <div class="logo text-center">
                         <img src="{{ Auth::user()->avatar }}" class="img-responsive center-block" alt="Logo" width="100px" height="100px">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-futbol-o" aria-hidden="true"></i> Mis Mejengas</a>
                        </li>
